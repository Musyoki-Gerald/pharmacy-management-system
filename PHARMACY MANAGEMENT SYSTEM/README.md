...
**ADMIN: 
Contains the employee ID, the username and password for the Admin. Only a single 
...
*Feel free to contact for any further queries via geraldmusyoki49@gmaill.com*
